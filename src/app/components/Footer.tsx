      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="mt-2 text-gray-400">Revolutionizing interview preparation with AI and 3D technology.</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-lg font-semibold text-white mb-4">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/interview/setup" className="text-gray-400 hover:text-purple-400 transition-colors">
                  Practice Interview
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">&copy; 2025 HoloView. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
